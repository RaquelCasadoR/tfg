...
def run_notebook(freq):
    print(f"Ejecutando notebook INICIAL para frecuencia {freq} con {len(df.columns)} activos...")
...
def save_results(results, output_file="final_accuracy_results_inic.csv"):
